...
function getElements() {
  return {
    ...
    disclaimerLink: requiredElement("#disclaimerLink"), disclaimerDialog: requiredElement("#disclaimerDialog"), closeDisclaimerBtn: requiredElement("#closeDisclaimerBtn"), userGuideLink: requiredElement("#userGuideLink"), userGuideDialog: requiredElement("#userGuideDialog"), closeUserGuideBtn: requiredElement("#closeUserGuideBtn"), userGuideFrame: requiredElement("#userGuideDialog iframe"), csvFormatLink: requiredElement("#csvFormatLink"), csvFormatLinkBtn: requiredElement("#csvFormatLinkBtn"),
    aiDeckDiscovery: requiredElement("#aiDeckDiscovery"), openAiDeckCreatorBtn: requiredElement("#openAiDeckCreatorBtn"), aiDeckDialog: requiredElement("#aiDeckDialog"), closeAiDeckDialogBtn: requiredElement("#closeAiDeckDialogBtn"), openAiPromptFromDeckBtn: requiredElement("#openAiPromptFromDeckBtn"), aiCsvFileNameInput: requiredElement("#aiCsvFileNameInput"), aiCsvContentInput: requiredElement("#aiCsvContentInput"), saveAiCsvBtn: requiredElement("#saveAiCsvBtn"), aiCsvSaveStatus: requiredElement("#aiCsvSaveStatus"),
    aiPromptDialog: requiredElement("#aiPromptDialog"), aiPromptText: requiredElement("#aiPromptText"), aiPromptCopyBtn: requiredElement("#aiPromptCopyBtn"), aiPromptDownloadBtn: requiredElement("#aiPromptDownloadBtn"), closeAiPromptDialogBtn: requiredElement("#closeAiPromptDialogBtn"), aiPromptCopyStatus: requiredElement("#aiPromptCopyStatus"),
  };
}
