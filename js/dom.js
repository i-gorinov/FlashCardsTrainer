...
function getElements() {
  return {
    ...
    sessionResetConfirmDialog: requiredElement("#sessionResetConfirmDialog"), cancelSessionResetBtn: requiredElement("#cancelSessionResetBtn"), okSessionResetBtn: requiredElement("#okSessionResetBtn"),
  };
}
